        ...
        {step1 && !step2 && (
          <div className="max-w-2xl my-10 mx-auto shadow-xl">
            <div className="w-full p-4 bg-gray-500 text-gray-100">
              <h1 className="text-xl font-bold leading-9">Checkout Proccess</h1>
            </div>
            <form
              onSubmit={formik.handleSubmit}
              className="flex flex-col gap-4 p-4 text-gray-800 border border-gray-300 shadow-md text-lg"
            >
        ...
        {!step1 && step2 && formik.values.payment == "paypal" && (
          <div className="max-w-2xl my-10 mx-auto shadow-xl">
            <div className="w-full p-4 bg-gray-600 text-gray-100">
              <h1 className="text-xl font-bold leading-9">Payment Proccess</h1>
            </div>
